...
The main endpoint, `/influxdb`, returns InfluxDB-formatted metrics for the Chainlink node. 
These metrics include the ETH and LINK balances for the node's account, the oracle contract address, and the gas price. 
Additionally, the endpoint can be configured to return extended metrics, which include statistics about Chainlink runs and jobs.
